...
export default class AuthorComponentsPage extends AlertPage {
...
export class AuthorDeleteDialog {
  ...
  title: ElementFinder = element(by.id('springLabWebApp.author.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-author'));
}
