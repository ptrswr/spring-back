...
export default class LoanComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('loan-heading'));
...
export class LoanDeleteDialog {
  ...
  title: ElementFinder = element(by.id('springLabWebApp.loan.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-loan'));
}
