...
export default class BookComponentsPage extends AlertPage {
...
export class BookDeleteDialog {
  ...
  title: ElementFinder = element(by.id('springLabWebApp.book.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-book'));
}
