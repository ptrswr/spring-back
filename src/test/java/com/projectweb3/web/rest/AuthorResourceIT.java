...
class AuthorResourceIT {
    ...
    public static Author createEntity(EntityManager em) {
        Author author = new Author().name(DEFAULT_NAME).surname(DEFAULT_SURNAME).country(DEFAULT_COUNTRY);
        return author;
    }
    ...
    public static Author createUpdatedEntity(EntityManager em) {
        Author author = new Author().name(UPDATED_NAME).surname(UPDATED_SURNAME).country(UPDATED_COUNTRY);
        return author;
    }
    ...
    void putNewAuthor() throws Exception {
        ...
        updatedAuthor.name(UPDATED_NAME).surname(UPDATED_SURNAME).country(UPDATED_COUNTRY);
    ...
    void partialUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.surname(UPDATED_SURNAME).country(UPDATED_COUNTRY);
    ...
    void fullUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.name(UPDATED_NAME).surname(UPDATED_SURNAME).country(UPDATED_COUNTRY);
